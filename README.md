...
- 👑 **Chairperson** – IEEE Professional Communication Society, KPRIET  
- ✍️ **Editor** – CSE Department Magazine, KPRIET  
- 🤝 **Active Member** – CSE Department Association, KPRIET  
- 📢 **Secretary** – Media Club, PSBB Millennium School  
- 🌍 **Mediator** – MILMUN (Model United Nations)  

---

## 📜 Certifications  

- HackerRank – Java (Basic), Problem Solving (Basic)  
- EF SET – **C1 Advanced (68/100)**  
- Tata – GenAI Powered Data Analytics Job Simulation  
- HP Life – Data Science & Analytics  
- Microsoft – Generative AI for Data Science  
- Infosys – Text Embeddings using LLMs  
- Google Cloud – Innovating with Google Cloud AI  
...
- **Tamil, Malayalam, Hindi** – Native / Bilingual Proficiency  

---

## 📫 Connect With Me  

- 💼 LinkedIn: www.linkedin.com/in/adhithiee-suresh-b15880297 
- 📧 Email: adhithiee2907@gmail.com  
